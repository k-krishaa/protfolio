...
export default function Portfolio4() {
  return <div className="hero-card mt-4 bg-white dark:bg-black rounded-xl p-8 md:p-12 shadow-sm border border-gray-100 dark:border-gray-800 transition-transform duration-300 ease-[cubic-bezier(0.34,1.56,0.64,1)] hover:-translate-y-1 hover:shadow-xl max-w-3xl mx-auto">
